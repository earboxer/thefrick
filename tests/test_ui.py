...
from thefrick import ui
from thefrick.types import CorrectedCommand
...
def patch_get_key(monkeypatch):
    def patch(vals):
        vals = iter(vals)
        monkeypatch.setattr('thefrick.ui.get_key', lambda: next(vals))
...
class TestSelectCommand(object):
    ...
    def test_without_commands(self, capsys):
        ...
        assert capsys.readouterr() == ('', 'No fricks given\n')

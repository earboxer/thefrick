...
import pytest
from thefrick.shells.tcsh import Tcsh
...
class TestTcsh(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('thefrick.shells.tcsh.Popen')
        mock.return_value.stdout.read.return_value = (
            b'frick\teval $(thefrick $(fc -ln -1))\n'
            b'l\tls -CF\n'
            b'la\tls -A\n'
            b'll\tls -alF')
        return mock
    ...
    def test_app_alias(self, shell):
        assert 'setenv TF_SHELL tcsh' in shell.app_alias('frick')

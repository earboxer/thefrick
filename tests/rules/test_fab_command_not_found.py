import pytest
from thefrick.rules.fab_command_not_found import match, get_new_command
...
@pytest.mark.parametrize('script, result', [
    ...
    ('fab extenson:version=2016 deloyp:beta=true -H the.frick',
     'fab prepare_extension:version=2016 deploy:beta=true -H the.frick'),
])

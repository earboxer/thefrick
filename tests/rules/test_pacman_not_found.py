...
from thefrick.rules import pacman_not_found
from thefrick.rules.pacman_not_found import match, get_new_command
...
@pytest.mark.parametrize('command', [
    ...
    Command('pacman llc', 'error: target not found: llc'),
    Command('sudo pacman llc', 'error: target not found: llc')])
@patch('thefrick.specific.archlinux.subprocess')

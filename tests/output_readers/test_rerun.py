...
from thefrick.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('thefrick.output_readers.rerun.Process')
    ...
    @patch('thefrick.output_readers.rerun._wait_output', return_value=False)
    @patch('thefrick.output_readers.rerun.Popen')
    ...
    @patch('thefrick.output_readers.rerun._kill_process')
    ...
    @patch('thefrick.output_readers.rerun.logs')

...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[thefrick.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype thefrick.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[thefrick.types.CorrectedCommand]
    :rtype: thefrick.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No fricks given' if get_alias() == 'frick'
                    else 'Nothing found')
        return
